    ...
    if (file_exists($strTargetPath)) {
        ...
        if (count($arrVideos)) {
            ...
            foreach ($arrVideos as $strVideoFilesName) {
                ...
                $arrSubtitleSearch['moviebytesize'] = filesize($strVideoFilesName);
                ...
                if (count($arrResponse) && isset($arrResponse['data'])) {
                    ...
                    //@TODO : here iterate other subtitles instead of taking the first one - based on whatever reasons:
                    ...
                    if (isset($arrSubtitleInfo['SubDownloadLink']) && isset($arrSubtitleInfo['SubFileName'])) {
                        ...
                        if ($boolSilentRun) echo "\r\n";
                        echo '[NOTICE] Subtitle download link or subtitle name missing. No subtitle found : ', $strVideoFilesName, "\r\n";
                    }
                } else {
                    if ($boolSilentRun) echo "\r\n";
